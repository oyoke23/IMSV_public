...
import com.oyoke.iara.databinding.FragmentCardMenuBinding
...
class CardMenuFragment : Fragment() {
    ...
    private fun showErrorMessage() {
        val message = when {
            binding.rgBoardSize.checkedRadioButtonId == -1 -> "Selecciona el tamaño del tablero"
            binding.rgSpeed.checkedRadioButtonId == -1 -> "Ajusta la velocidad del tablero"
